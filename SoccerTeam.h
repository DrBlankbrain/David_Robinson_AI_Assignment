...
private:
  ...
  //Which AI the players are commanded by 
  int oppositionAI = 3; // either Good or Bad depending on mode selected
  int playerAI = 0; //normal AI
...
public:
  ...
  void		  ChangeRole(int playerNo, bool closeGame);
