    ...
    case WM_KEYUP:
      {
        switch(wParam)
        {
		    ...
		    case 'D':
		    {
				g_SoccerPitch->m_pRedTeam->SetOppositionAI(1);
#ifdef AI_SETTING_INFO_ON
				debug_con << "AI Setting on Keeper Charge" << "";
#endif
		    }
		    break;
		    ...
		    case 'O':
	   	    {
#ifdef AI_SETTING_INFO_ON
				debug_con << "AI Setting on Offside Rule" << "";
#endif
				g_SoccerPitch->m_pRedTeam->SetOppositionAI(2); 
		    }
		    ...
		    {
#ifdef AI_SETTING_INFO_ON
				debug_con << "AI Setting on Plain Old Simple" << "";
#endif

			 g_SoccerPitch->m_pRedTeam->SetOppositionAI(3);
		    }
			break;
			...
			{
#ifdef AI_SETTING_INFO_ON
				debug_con << "AI Tactic Suorround" << "";
#endif

				g_SoccerPitch->m_pRedTeam->SetOppositionAI(4);
			}
