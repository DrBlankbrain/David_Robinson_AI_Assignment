...
void SoccerTeam::AllPlayersChase()const
{
	std::vector<PlayerBase*>::const_iterator it = m_Players.begin();
...
void SoccerTeam::ChangeRole(int playerNo, bool closeGame)
{

		if (playerNo == 2 && closeGame == false)
		{
			m_Players[2]->PlayerBase::defender;
		}
		else if (playerNo == 2 && closeGame == true)
		{
			m_Players[playerNo]->PlayerBase::attacker;
		}

		if (playerNo == 7 && closeGame == false)
		{
			m_Players[playerNo]->PlayerBase::defender;
		}
		else if (playerNo == 7 && closeGame == true)
		{
			m_Players[playerNo]->PlayerBase::attacker;
		}

		if (playerNo == 3 && closeGame == false)
		{
			m_Players[playerNo]->PlayerBase::attacker;
		}
		else if (playerNo == 3 && closeGame == true)
		{
			m_Players[playerNo]->PlayerBase::defender;
		}


		if (playerNo == 8 && closeGame == false)
		{
			m_Players[playerNo]->PlayerBase::attacker;
		}
		else if (playerNo == 8 && closeGame == true) 
		{
			m_Players[playerNo]->PlayerBase::defender;
		}
}
...
void SoccerTeam::SetOppositionAI(int AI)
{
	oppositionAI = AI;
}

int SoccerTeam::GetOppositionAI()
{
	return oppositionAI;
}
...
bool SoccerTeam::checkAllPlayersAIHarrasing() const
{
	if (oppositionAI == 4)
		return true;
	else
